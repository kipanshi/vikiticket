...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Row.prefix'
        db.add_column('core_row', 'prefix', self.gf('django.db.models.fields.CharField')(max_length=72, null=True, blank=True), keep_default=False)

        # Adding field 'Row.suffix'
        db.add_column('core_row', 'suffix', self.gf('django.db.models.fields.CharField')(max_length=72, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Row.prefix'
        db.delete_column('core_row', 'prefix')

        # Deleting field 'Row.suffix'
        db.delete_column('core_row', 'suffix')
